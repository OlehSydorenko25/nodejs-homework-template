...
router.patch('/:contactId', guard,  validateMongoId, validationUpdateContact, ctrl.updateContact)

router.patch('/:contactId/favorite', guard,  validateMongoId, validationUpdateContactFavorite, ctrl.updateStatusContact)
